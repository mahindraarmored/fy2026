var mapData = window.mapData = {
    ...
    countries: [
        ...
        { name: "Denmark", manager: "MR. MARCOS", coords: [56.2639, 9.5018] },
        { name: "Sweden", manager: "MR. MARCOS", coords: [60.1282, 18.6435] },
        { name: "Norway", manager: "MR. MARCOS", coords: [60.4720, 8.4689] },
        { name: "Estonia", manager: "MR. MARCOS", coords: [58.5953, 25.0136] },
        { name: "Switzerland", manager: "MR. MARCOS", coords: [46.8182, 8.2275] },
        { name: "Lithuania", manager: "MR. MARCOS", coords: [55.1694, 23.8813] },
    ...
    agencies: [
        ...
        { name: "Control Risk", manager: "MR. RAJIV", coords: [51.5074, -0.1278] },
        ...
        { name: "Norwegian Refugee Council", manager: "MR. NADER", coords: [59.9139, 10.7522] },
        ...
        { name: "GardaWorld", manager: "MR. ROWAN", coords: [45.5017, -73.5673] },
        { name: "CSI LLC", manager: "MR. ROWAN", coords: [38.8977, -77.0365] },
        { name: "G4S", manager: "MR. ROWAN", coords: [51.5074, -0.1278] },
        ...
        { name: "Hart International", manager: "MR. ROWAN", coords: [25.2048, 55.2708] },
        ...
        { name: "UNOCHA", manager: "MR. AZMI", coords: [40.7505, -73.9671] },
        { name: "JICA", manager: "MR. AZMI", coords: [35.6852, 139.7298] },
        { name: "Danish Refugee Council", manager: "MR. AZMI", coords: [55.6761, 12.5683] },
        { name: "IMC (Intl Medical Corps)", manager: "MR. AZMI", coords: [34.0522, -118.2437] },
        { name: "World Central Kitchen", manager: "MR. AZMI", coords: [38.9072, -77.0369] },
        { name: "World Vision", manager: "MR. AZMI", coords: [34.0673, -117.9211] },
